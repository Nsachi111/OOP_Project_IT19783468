...
public class Undergraduate_Programs {
    ...
    public int Payment_Details;
     ...
     public Undergraduate_Programs(String Program_ID  ,String Program_Name ,int Duration,String Subjects,int Payment_Details ){
